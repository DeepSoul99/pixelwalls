...
import { Sparkles, Heart, LayoutGrid, Compass, PlusCircle, LogOut, User } from 'lucide-react';
        ...
        <div className="h-20 px-6 flex items-center justify-between border-b border-white/5 shrink-0">
           <div className="flex items-center">
             ...
             <div className="flex flex-col">
               ...
               <a
                 ...
                 className="text-[10px] text-zinc-500 hover:text-purple-400 transition-colors font-medium"
               >
                 Created by @ammaar
               </a>
             </div>
           ...
           <div className="flex items-center gap-2">
             <div className="flex items-center gap-2 px-3 py-1.5 bg-zinc-800/50 rounded-lg border border-white/5">
               ...
               <span className="text-xs text-zinc-300 max-w-[100px] truncate">{user?.email}</span>
             </div>
             <button
               onClick={signOut}
               className="p-2 rounded-lg bg-zinc-800/50 border border-white/5 text-zinc-400 hover:text-red-400 hover:border-red-500/30 transition-all"
               title="로그아웃"
             >
